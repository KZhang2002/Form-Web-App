...
export const AdminNavDrawer = () => {
  return (
    <div data-layer="Navigation Drawer/Default"
      ...
      <div data-layer="User List"
           className="UserList self-stretch h-14 rounded-[100px] justify-start items-center gap-3 inline-flex overflow-hidden">
        <div data-layer="state-layer"
             className="StateLayer grow shrink basis-0 self-stretch pl-4 pr-6 py-4 justify-start items-center gap-3 flex">
          {/* <UserIcon /> */}
          <div data-layer="Label"
      ...
      <div data-layer="Form List"
           className="FormList self-stretch h-14 rounded-[100px] justify-start items-center gap-3 inline-flex overflow-hidden">
        <div data-layer="state-layer"
             className="StateLayer grow shrink basis-0 self-stretch pl-4 pr-6 py-4 justify-start items-center gap-3 flex">
            {/* <FormIcon /> */}
          <div data-layer="Label"
      ...
      <div data-layer="Account Creation"
           className="AccountCreation self-stretch h-14 rounded-[100px] justify-start items-center gap-3 inline-flex overflow-hidden">
        <div data-layer="state-layer"
             className="StateLayer grow shrink basis-0 self-stretch pl-4 pr-6 py-4 justify-start items-center gap-3 flex">
          {/*<UserIcon />*/}
          <div data-layer="Label"
