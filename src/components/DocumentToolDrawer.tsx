...
export const DocumentToolDrawer = () => {
  return (
    <div data-layer="Navigation Drawer/Default"
      ...
      <div data-layer="Inbox"
        ...
        <div data-layer="state-layer"
          ...
          <div data-layer="Label"
               className="Label grow shrink basis-0 text-[#49454f] text-sm font-medium font-['Roboto'] leading-tight tracking-tight">Document Approval
          </div>
        </div>
      </div>
      <div data-layer="Sent"
      ...
      <div data-layer="Drafts"
        ...
        <div data-layer="state-layer"
             className="StateLayer grow shrink basis-0 self-stretch pl-4 pr-6 py-4 justify-start items-center gap-3 flex">
          <div data-layer="Label"
               className="Label grow shrink basis-0 text-[#49454f] text-sm font-medium font-['Roboto'] leading-tight tracking-tight">Delete
          </div>
        </div>
      </div>
    </div>
